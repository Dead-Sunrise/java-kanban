...
public class Main {
    public static void main(String[] args) {
        ...
        manager.createSubTask(new SubTask("Подзадача 1 Эпик 1", "Описание подзадачи",
                ...
                Duration.ofHours(1)), 2, Status.NEW);
        manager.createSubTask(new SubTask("Подзадача 2 Эпик 1", "Описание подзадачи",
                LocalDateTime.of(2025, Month.MAY, 4, 10, 0),
                Duration.ofHours(1)), 2, Status.DONE);
        manager.createSubTask(new SubTask("Подзадача 3 Эпик 1", "Описание подзадачи",
                LocalDateTime.of(2025, Month.MAY, 5, 10, 0),
                Duration.ofHours(1)), 2, Status.IN_PROGRESS);
        manager.createSubTask(new SubTask("Подзадача 1 Эпик 2", "Описание подзадачи",
                LocalDateTime.of(2025, Month.MAY, 6, 10, 0),
                Duration.ofHours(1)), 3, Status.DONE);
