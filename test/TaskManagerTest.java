...
public abstract class TaskManagerTest<T extends TaskManager> {
    ...
    void createAndDeleteTasks() { //тест на создание задач, удаление по одной, удаление всех задач
        ...
        Task task4 = new Task("Задача4", "Описание", Status.NEW,
                LocalDateTime.of(2025, Month.MAY, 4, 10, 0), Duration.ofHours(1));
        SubTask subTask1Epic1 = new SubTask("Подзадача 1", "Описание1", Status.IN_PROGRESS, 0,
                LocalDateTime.of(2025, Month.MAY, 5, 10, 0), Duration.ofHours(1));
        SubTask subTask2Epic1 = new SubTask("Подзадача 2", "Описание2", Status.IN_PROGRESS, 0,
                LocalDateTime.of(2025, Month.MAY, 6, 10, 0), Duration.ofHours(1));
        SubTask subTask3Epic1 = new SubTask("Подзадача 3", "Описание3", Status.IN_PROGRESS, 0,
                LocalDateTime.of(2025, Month.MAY, 7, 10, 0), Duration.ofHours(1));
        SubTask subTask1Epic2 = new SubTask("Подзадача 1", "Описание1", Status.IN_PROGRESS, 1,
                LocalDateTime.of(2025, Month.MAY, 8, 10, 0), Duration.ofHours(1));
        SubTask subTask2Epic2 = new SubTask("Подзадача 2", "Описание2", Status.IN_PROGRESS, 1,
                LocalDateTime.of(2025, Month.MAY, 9, 10, 0), Duration.ofHours(1));
        SubTask subTask3Epic2 = new SubTask("Подзадача 3", "Описание3", Status.IN_PROGRESS, 1,
        ...
        manager.createSubTask(subTask3Epic2);
    ...
    void testFieldsAfterAddTask() { //Тест на совпадение полей после добавления задачи
        Task firstTask = new Task("Задача", "Подзадача", Status.NEW,
                LocalDateTime.of(2025, Month.MAY, 2, 10, 0), Duration.ofHours(1));
        firstTask.setId(0);
    ...
    void testTaskId() {// при присвоении id до добавления задачи, генерируется новый уникальный id после добавления
        ...
        manager.createTask(taskGenerateId);
        Task taskCreateId = new Task("Задача", "id задан");
        taskCreateId.setId(5);
        manager.createTask(taskCreateId);
    ...
    void testDeleteSubTask() { // тест удаления подзадачи из спика подзадач эпика при удалении из менеджера
        Epic epic = new Epic("Эпик", "Описание");
        manager.createEpic(epic);
        SubTask subTask1 = new SubTask("Подзадача1", "Описание1", Status.NEW, 0,
                LocalDateTime.of(2025, Month.MAY, 1, 10, 0), Duration.ofHours(1));
        manager.createSubTask(subTask1);
        SubTask subTask2 = new SubTask("Подзадача2", "Описание2", Status.NEW, 0,
                LocalDateTime.of(2025, Month.MAY, 2, 10, 0), Duration.ofHours(1));
        manager.createSubTask(subTask2);
        SubTask subTask3 = new SubTask("Подзадача3", "Описание3", Status.NEW, 0,
                LocalDateTime.of(2025, Month.MAY, 3, 10, 0), Duration.ofHours(1));
    ...
    void testEpicStatus() { //тест расчета статуса эпика при разных условиях
        Epic epic = new Epic("Эпик", "Описание");
        SubTask subTask1 = new SubTask("Подзадача 1", "Описание1", Status.NEW, 0,
                LocalDateTime.of(2025, Month.MAY, 1, 10, 0), Duration.ofHours(1));
        SubTask subTask2 = new SubTask("Подзадача 2", "Описание2", Status.NEW, 0,
                LocalDateTime.of(2025, Month.MAY, 2, 10, 0), Duration.ofHours(1));
        SubTask subTask3 = new SubTask("Подзадача 3", "Описание3", Status.NEW, 0,
                LocalDateTime.of(2025, Month.MAY, 3, 10, 0), Duration.ofHours(1));
        manager.createEpic(epic);
        manager.createSubTask(subTask1);
        manager.createSubTask(subTask2);
    ...
    void testIntersection() { //тест добавления задач с пересечением по времени при разных условиях
        Task firstTask = new Task("Задача", "Описание", Status.NEW,
                LocalDateTime.of(2025, Month.MAY, 1, 10, 0), Duration.ofHours(1));
        manager.createTask(firstTask);
        // полное пересечение
        ...
        Task task6 = new Task("Задача", "Описание", Status.NEW,
        ...
        Task task7 = new Task("Задача", "Описание", Status.NEW,
        ...
        Task task8 = new Task("Задача", "Описание", Status.NEW,
    ...
    void testPrioritizedTasks() { // тест добавления задач/задач без заданного времени, в приоритетный список
        ...
        Task task3 = new Task("Задача3", "Описание", Status.NEW,
                LocalDateTime.of(2025, Month.MAY, 2, 10, 0), Duration.ofHours(1));
        Task task4 = new Task("Задача4", "Описание", Status.NEW, null, Duration.ofHours(1));
        manager.createTask(task1);
        manager.createTask(task2);
        manager.createTask(task3);
        manager.createTask(task4);
